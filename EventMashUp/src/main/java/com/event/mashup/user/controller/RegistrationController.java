package com.event.mashup.user.controller;
...
import com.event.mashup.security.util.SecurityUtil;
import com.event.mashup.user.dto.RegistrationForm;
import com.event.mashup.user.model.SocialMediaService;
import com.event.mashup.user.model.User;
import com.event.mashup.user.service.DuplicateEmailException;
import com.event.mashup.user.service.UserService;
